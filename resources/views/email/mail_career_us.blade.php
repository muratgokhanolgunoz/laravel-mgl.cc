								...
								<tr>
									...
									<td style="padding: 30px 0 30px 0; border-bottom: solid 1px #eeeeee;" align="right">
										<a href="https://mgl.cc" target="_blank"
											...
											<span style="text-transform: uppercase;">Click for our website</span>
										</a>
									</td>
								</tr>
							</table>
							...
							<table class="container hero-subheader" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td class="hero-subheader__title"
										...
										align="center">Thanks you for your apply</td>
								</tr>
								...
								<tr>
									<td class="hero-subheader__content"
										...
										align="justify">
										Dear <b><?= ucfirst($name) ?> <?= strtoupper($surname) ?></b> ;
										<br>
										<br>
										Your application has been received successfully. We will check the application requests for the last 90 days. In case of need the human resources will contact you. For your question or suggestion, you can send a message to our e-mail address below. We wish you healthy days.
									</td>
								</tr>
							</table>
							<!-- /// Hero subheader -->
										...
										<table class="container" border="0" cellpadding="0" cellspacing="0" width="620"
											...
											<tr>
												<td
													...
													Copyright &copy; <?php echo date('Y') ?> Midas Global Logistic.
													<br />
													All rights reserved.
												</td>
											</tr>
