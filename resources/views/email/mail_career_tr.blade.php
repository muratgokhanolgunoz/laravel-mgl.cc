...
<head>
	...
	<title>Midas Global Lojistik</title>
	<link rel="icon" href="https://mgl.cc/assets/img/favicon.ico" />
	<style type="text/css">
		/* ----- Custom Font Import ----- */
							...
							<table class="container header" border="0" cellpadding="0" cellspacing="0" width="620"
								...
								<tr>
									<td style="padding: 30px 0 30px 0; border-bottom: solid 1px #eeeeee;" align="left">
										<a href="https://mgl.cc" target="_blank">
											<img src="https://mgl.cc/assets/img/logo.png" />
										</a>
									</td>
									<td style="padding: 30px 0 30px 0; border-bottom: solid 1px #eeeeee;" align="right">
										<a href="https://mgl.cc" target="_blank"
											style="color: #969696; text-decoration: none">
											<span style="text-transform: uppercase;">Web sİtemİz İçİn tıklayın</span>
										</a>
									</td>
								</tr>
							</table>
							...
							<table class="container hero-subheader" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td class="hero-subheader__title"
										style="font-size: 40px; font-weight: bold; padding: 40px 0 15px 0;"
										align="center">Başvurunuz için teşekkür ederiz</td>
								</tr>

								<tr>
									<td class="hero-subheader__content"
										style="font-size: 20px; line-height: 27px; color: #969696; padding: 0 60px 40px 0;"
										align="justify">
										Sayın <b><?= ucfirst($name) ?> <?= strtoupper($surname) ?></b> ;
										<br>
										<br>
										Başvuru talebiniz tarafımıza ulaştı. Çalışan ihtiyacımız olduğunda son 90 günlük talepler incelenmekte ve insan kaynakları departmanımız tarafından başvuruya dönülmektedir.  Soru veya önerileriniz için aşağıda bulunan e-posta adresimize mesaj gönderebilirsiniz. Sağlıklı günler dileriz.
									</td>
								</tr>
							</table>
							<!-- /// Hero subheader -->
											...
											<tr>
													...
													<table class="container" border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="info-bullets__content" style="color: #969696; font-size: 16px;">
																<a href="mailto:info@mgl.cc" style="color: #969696; text-decoration: none">info@mgl.cc</a>
															</td>
														</tr>
													</table>
												</td>
												...
												<td class="info-bullets__block" style="padding: 30px 30px 15px 30px;"
													...
													<table class="container" border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="info-bullets__content" style="color: #969696; font-size: 16px;">
																<a href="tel:902124381818" style="color: #969696; text-decoration: none">+90 (212) 438 18 18</a>
															</td>
														</tr>
													</table>
												</td>
								...
								<tr>
									<td align="center">
										<table class="container" border="0" cellpadding="0" cellspacing="0" width="620"
											...
											<tr>
												<td
													style="color: #969696; text-align: center; font-size: 16px; padding: 10px 0 20px 0; line-height: 22px;">
													Copyright &copy; <?php echo date('Y') ?> Midas Global Lojistik.
													<br />
